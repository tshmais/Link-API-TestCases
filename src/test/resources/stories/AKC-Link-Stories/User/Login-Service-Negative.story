...
Scenario:TC-001_USER_Negative: Login using empty data for loginProvider
...
Scenario: TC-002_USER_Negative: Login using empty data for loginProviderId
Given service method is post
When the service url is: Login_service
And add to the header Content-Type with value application/json
And we set Body with {
...
Scenario:TC-003_USER_Negative: Login using empty data for password
Given service method is post
When the service url is: Login_service
And add to the header Content-Type with value application/json
And we set Body with {
...
Scenario: TC-005_USER_Negative: Login using invalid data for loginProvider
Given service method is post
When the service url is: Login_service
And add to the header Content-Type with value application/json
And we set Body with {
...
Scenario:TC-006_USER_Negative: Login using invalid data for loginProviderId
Given service method is post
When the service url is: Login_service
And add to the header Content-Type with value application/json
And we set Body with {
...
Scenario:TC-007_USER_Negative: Login using invalid data for password
Given service method is post
When the service url is: Login_service
And add to the header Content-Type with value application/json
And we set Body with {
...
Scenario:TC-009_USER_Negative: Login using user data for user not exist
Given service method is post
When the service url is: Login_service
And add to the header Content-Type with value application/json
And we set Body with {
...
Scenario:TC-010_USER_Negative: Login using empty data for All paramters
Given service method is post
When the service url is: Login_service
And add to the header Content-Type with value application/json
And we set Body with {
