Meta:
@User_App
@Get_User_App_Inctance_Positive_scenarios
@User_App_Positive
@ReportName User_App_Inctance_Positive
@Link
...
When The service url equals: Get_User_App_Inctance with Same_User_ID with Empty_ID
And add to the header Content-Type with value application/json
And add Session Authorization to Request header
