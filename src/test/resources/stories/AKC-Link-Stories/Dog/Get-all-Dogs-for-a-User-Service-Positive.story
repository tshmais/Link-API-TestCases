...
Scenario: TC-001_DOG_Positive: Get all dogs for a user using valid data for New user
...
Scenario: TC-002_DOG_Positive: Get all dogs for a user using valid data for old user
...
Scenario: TC-004_DOG_Positive: Get all dogs for a user using valid data for user with multi dogs 
...
Scenario: TC-005_DOG_Positive: Get all dogs for a user using valid data for user with one dog 
...
Scenario: TC-007_DOG_Positive: Get all dogs for a user using valid data for user without dogs
